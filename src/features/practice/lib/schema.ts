  ...
  questions: z.array(
    z.object({
      ...
      explanation: z.object({
        meaning: z.string().describe('Meaning of the sentence/passage in Vietnamese'),
        grammarAnalysis: z.string().describe('Grammar explanation in Vietnamese'),
        vocabularyNotes: z.string().describe('Key vocabulary notes in Vietnamese'),
        whyCorrect: z.string().describe('Why the answer is correct in Vietnamese'),
        whyOthersWrong: z.string().optional().describe('Why other options are wrong'),
