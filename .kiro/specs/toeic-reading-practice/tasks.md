...
- [-] 2. Implement AI service integration
  - [ ] 2.1 Create AI service with OpenRouter configuration
  ...
  - [ ] 2.2 Create question parser service
  ...
  - [ ] 2.3 Create API route for server-side AI processing
...
- [ ] 3. Build practice hook for state management
...
- [ ] 4. Create image input component
  - [ ] 4.1 Implement image upload and preview
...
- [ ] 6. Build practice input panel
  - [ ] 6.1 Create part selector
  ...
  - [ ] 6.3 Add submit button and form handling
...
- [ ] 7. Create question card component
...
- [ ] 8. Build explanation grid layout
...
- [ ] 9. Integrate components in main page
...
- [ ] 10. Configure environment and dependencies
...
- [ ] 11. Add Vietnamese language content
...
- [ ] 12. Implement auto part detection
...
- [ ] 13. Polish UI and responsive design
